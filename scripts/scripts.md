...
O workflow (`.github/workflows/backfill.yml`) resolve o ambiente automaticamente pelo branch selecionado, autentica via OIDC no ambiente correspondente e configura todas as variáveis de ambiente automaticamente.
...
O workflow `.github/workflows/backfill.yml` reconhece esse código: renova a
...
(`.github/workflows/backfill.yml`) monta o ARN do tópico
...
(`.github/workflows/backfill.yml`) escreve no step summary do GitHub
