...
| | Descrição |
|---|---|
| **Entrada** | Evento JSON do EventBridge com `type`, nomes de tabelas e flags opcionais (`only_weekly_tables`, `only_annual_tables`, `only_monthly_tables`, `only_changes_tables`, `only_rotation_refresh`, `translate_provider`) |
