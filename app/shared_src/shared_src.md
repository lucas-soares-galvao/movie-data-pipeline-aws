...
| `glue_details` | `api_get`, `get_api_secret`, `get_resolved_option`, `traduzir_texto`, `traduzir_em_paralelo`, `elegivel_overview_pt`, `elegivel_tagline_pt`, `elegivel_keywords_pt`, `trigger_glue_job` |
| `glue_etl` | `get_resolved_option`, `traduzir_texto`, `trigger_glue_job` |
| `scripts/backfill_traducao.py` | `traduzir_texto`, `traduzir_em_paralelo`, `elegivel_overview_pt`, `elegivel_tagline_pt`, `elegivel_keywords_pt` |
