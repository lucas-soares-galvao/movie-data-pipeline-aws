...
- **Backfill manual (`backfill.yml`) não tem observabilidade equivalente ao pipeline agendado** — falhas dentro de um backfill não geram alarme/SNS automaticamente, dependem do operador acompanhar o log do workflow no GitHub Actions.
