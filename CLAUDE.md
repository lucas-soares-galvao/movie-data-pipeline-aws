...
- **revisao-pendencias-sonarqube** — Consulta (somente leitura, via API pública do SonarCloud) das pendências da aba Overall Code: Security, Reliability, Maintainability, Accepted Issues, Coverage, Duplications e Security Hotspots, mais o Quality Gate, com ponte para as skills que corrigem cada tipo de achado
