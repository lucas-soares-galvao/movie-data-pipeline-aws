...
# manual sob demanda (backfill.yml)
# =============================================================================
#
# Antes desta role, o workflow backfill.yml assumia a mesma role de CI/CD
...
locals {
  ...
  # backfill.yml (develop→dev, main→prod). Reforço de segurança além do
...
resource "aws_iam_role" "backfill" {
  ...
  # backfill.yml usa --duration-seconds 3600 hardcoded ao renovar a
