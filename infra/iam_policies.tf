    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          "arn:aws:glue:sa-east-1:${data.aws_caller_identity.current.account_id}:database/${local.envs.glue_catalog_database_movie_name}",
          "arn:aws:glue:sa-east-1:${data.aws_caller_identity.current.account_id}:database/${local.envs.glue_catalog_database_tv_name}",
          "arn:aws:glue:sa-east-1:${data.aws_caller_identity.current.account_id}:table/${local.envs.glue_catalog_database_movie_name}/*",
          "arn:aws:glue:sa-east-1:${data.aws_caller_identity.current.account_id}:table/${local.envs.glue_catalog_database_tv_name}/*",
        ]
      },
      {
        Sid    = "WriteSOTTable"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = ["s3:PutObject", "s3:DeleteObject", "s3:GetObject"]
        Resource = [
          "arn:aws:s3:::${local.envs.s3_bucket_sot}/${local.tmdb_prefix}/${local.envs.glue_catalog_table_details_movie_name}/*",
          "arn:aws:s3:::${local.envs.s3_bucket_sot}/${local.tmdb_prefix}/${local.envs.glue_catalog_table_details_tv_name}/*",
          "arn:aws:s3:::${local.envs.s3_bucket_sot}/${local.tmdb_prefix}/${local.envs.glue_catalog_table_watch_providers_movie_name}/*",
          "arn:aws:s3:::${local.envs.s3_bucket_sot}/${local.tmdb_prefix}/${local.envs.glue_catalog_table_watch_providers_tv_name}/*"
        ]
      }
    ]
  })
