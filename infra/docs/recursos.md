...
- Swap de 1 GB criado automaticamente no bootstrap (`deploy_lightsail.yml`) — necessário no bundle `nano_3_0`/`micro_3_0` para o `pip install`/app não sofrerem OOM kill; aplicado em qualquer bundle, custo de disco desprezível
