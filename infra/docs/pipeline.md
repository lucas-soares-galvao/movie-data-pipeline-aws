...
| `lambda_api_movie_rotation_weekly` | Semanal (sáb) | 06:10 BRT (09:10 UTC) | `only_rotation_refresh=true` — refresh forçado de 1 ano do catálogo antigo (filmes), ponteiro via SSM |
| `lambda_api_tv_rotation_weekly` | Semanal (sáb) | 06:15 BRT (09:15 UTC) | `only_rotation_refresh=true` — refresh forçado de 1 ano do catálogo antigo (séries), ponteiro via SSM |
