...
|---|---|---|---|
| `lambda_api_movie_weekly` | Semanal (dom) | 07:00 BRT (10:00 UTC) | `only_weekly_table=true` — filmes novos + now_playing |
| `lambda_api_tv_weekly` | Semanal (dom) | 07:05 BRT (10:05 UTC) | `only_weekly_table=true` — séries novas |
